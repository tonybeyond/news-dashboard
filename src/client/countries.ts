// 2-letter ISO country code → human-readable name. Used by the filter
// dropdown so the user sees "United States" rather than "US". Subset of
// the most common codes seen in GDELT; anything not in the map falls back
// to the bare 2-letter code.
...
const COUNTRY_NAMES: Record<string, string> = {
  ...
  // Common non-ISO codes used by GDELT for disputed / special territories
